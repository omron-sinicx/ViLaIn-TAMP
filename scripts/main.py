...
def main():
    """ Full example script of PD generation with ViLain."""
    ...
    # Getting bounding boxes for the fixed objects
    ...
    # Perform object detection using ViLaIn
    detection_result = vilain.detect_objects(
        images[-1],
        fixed_bboxes,
        "cooking",
        (640, 640),
        dummy_detection=True, ### Use dummy detection for testing
    )

    print("-" * 30)
    print("### prompt:\n", detection_result["prompt"])
